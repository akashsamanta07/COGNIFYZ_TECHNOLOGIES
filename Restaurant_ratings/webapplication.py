...
main_model=pk.load(open("pickle_model\main_model.pkl","rb"))
city_model=pk.load(open("pickle_model\city_model.pkl","rb"))
hod_model=pk.load(open("pickle_model\hod_model.pkl","rb"))
htb_model=pk.load(open("pickle_model\htb_model.pkl","rb"))
sc_model=pk.load(open("pickle_model\sc_model.pkl","rb"))
